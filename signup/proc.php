<?php
    ...
    if(isset($_POST['username'])){
        ...
        $holdVar = [$name, $username, $phone, $email, $pass, $region, $city, $category, $lancer, $days, $travel];
        $holdLen = count($holdVar);
        ...
        if(!empty($holdErr)){
            $emperr = "Empty fields detected";
            header("Location: index.php?err=$emperr");
        }

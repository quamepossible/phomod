...
<ul>
 ...
 <li>When you're done setting up your domain (localhost:3000), go to <b>index.php</p> of your <b>PHOMOD</b> folder, and in the <head> </head> tag, look for this line <br>

...
<?php include 'userheader.php'?>
            <?php if($verified == 'NO'):?>
                <?php header('Location: reviewuser.php?name='.$username)?>
            <?php else:?>
                                ...
                                <div class="row">
                                    ...
                                    <div class="las-row">
                                        <form action="verify.php" method="POST">
                                            ...
                                            <button class="btn btn-warning" id="unverify"><ion-icon name="close-circle-outline" class="ver-ico"></ion-icon>Unverify</button>
                                        </form>
                                    </div>

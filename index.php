      ...
      <?php if(!isset($_SESSION['log'])):?>
            <nav>
                ...
                <ul class="row">                    
                    ...
                    <li class="log-li"><a href="javascript:void(0)" id="mtlog" class="log" data-toggle="modal" data-target="#loginModal"><ion-icon class="log-ico" name="person-circle-outline"></ion-icon><span>LOG IN</span></a></li>
